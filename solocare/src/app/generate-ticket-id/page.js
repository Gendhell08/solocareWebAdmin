...
import TimeSelector from "../component/time";
        ...
        <div>
            ...
            <div className="flex">
              <div className="flex w-full h-[40px] bg-blue-900">
                <p className="text-center text-white font-bold text-3xl tracking-widest w-full">TICKET ID</p>
              </div> 
            </div>

            <div className="flex">
              <div className="flex w-full h-[70px] bg-white">
                <p className="text-center mt-1 text-primary font-bold text-3xl tracking-widest w-full">CUSTOM TICKET</p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="w-3/4 flex h-screen">
                <div className="w-1/2 p-2">
                  ...
                  <div className="p-4 mt-2">
                    <p className="text-xl tracking-widest font-semibold text-black/60">Barangay<span className="text-red-500 text-xl">*</span>
                      <input className="focus:outline-none focus:border-primary focus:ring-transparent mt-2 text-xl p-2 border-[3px] font-medium border-primary/60 w-full rounded-2xl"></input></p>
                  </div>

                  <div className="p-4 mt-2">
                    <p className="text-xl tracking-widest font-semibold text-black/60">Ticket Type<span className="text-red-500 text-xl">*</span>
                      <input className="focus:outline-none focus:border-primary focus:ring-transparent mt-2 text-xl p-2 border-[3px] font-medium border-primary/60 w-full rounded-2xl"></input></p>
                  </div>
