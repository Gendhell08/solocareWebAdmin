      ...
      return(
          <div>
                ...
                <div className="flex">
                    ...
                    <p className="text-center text-white font-bold text-3xl tracking-widest w-full">REGISTRY SERVICE</p>
                    </div> 
                </div>
                    ...
                    <div className="w-9/12 h-screen">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="w-full">
                                        <div className="flex items-end justify-end pt-5 pb-2 pr-2">
                                            <span className="pr-2 text-nowrap text-[12px] text-blue-950 text-base font-bold">(number)</span>
                                        </div>
                        ...
                        <div className="flex items-end justify-end">
                            <div className="mt-3 mr-5">
                                ...
                                <UserNotify isOpen={isApprovedUserOpen} onClose={handleClose} redirectUrl="/registration-sms"/>
                            </div>
                        </div>
                    </div>
                </div>
