                ...
                <div className="flex-1 bg-white">
                    <div className="flex flex-col justify-center items-center h-full w-full">
                        <h1 className="text-primary font-bold text-2xl w-full p-20">
                            ...
                            <div>
                                <input className=" focus:outline-none focus:border-primary focus:ring-transparent mt-10 font-normal text-base text-black" label="Admin Number" type="text" placeholder="Admin Number"></input>
                            </div>
                            <div>
                            ...
                            <button className="text-xl font-medium text-white btn-primary mt-10" type="submit" onClick={() => login('/admin-dashboard')}>Log In</button>
                        </h1>
                    </div>
                </div>
            </div>
